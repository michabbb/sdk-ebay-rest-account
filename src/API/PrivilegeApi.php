...
class PrivilegeApi
{
     ...
     * @return \macropage\SDKs\ebay\rest\account\Model\SellingPrivileges
     */
     ...
     * @throws \macropage\SDKs\ebay\rest\account\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \macropage\SDKs\ebay\rest\account\Model\SellingPrivileges, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    if ('\macropage\SDKs\ebay\rest\account\Model\SellingPrivileges' === '\SplFileObject') {
                        ...
                        if ('\macropage\SDKs\ebay\rest\account\Model\SellingPrivileges' !== 'string') {
