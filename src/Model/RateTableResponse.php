...
class RateTableResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'rateTables' => '\macropage\SDKs\ebay\rest\account\Model\RateTable[]'
    ];
    ...
    {
        $this->container['rateTables'] = isset($data['rateTables']) ? $data['rateTables'] : null;
    }
     ...
     * Gets rateTables
     *
     * @return \macropage\SDKs\ebay\rest\account\Model\RateTable[]|null
     */
    public function getRateTables()
    {
        return $this->container['rateTables'];
    }

    /**
     * Sets rateTables
     *
     * @param \macropage\SDKs\ebay\rest\account\Model\RateTable[]|null $rateTables A list of elements that provide information on the seller-defined shipping rate tables.
     *
     * @return $this
     */
    public function setRateTables($rateTables)
    {
        $this->container['rateTables'] = $rateTables;
