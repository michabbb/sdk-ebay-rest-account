...
class FulfillmentPolicyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('fulfillmentPolicies', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\account\Model\FulfillmentPolicy[]|null $fulfillmentPolicies A list of all of the seller's fulfillment policies defined for the specified marketplace. This array will be returned as empty if no fulfillment policies are defined for the specified marketplace.
     *
     * @return self
     */
    public function setFulfillmentPolicies($fulfillmentPolicies)
    {
        ...
        if (is_null($fulfillmentPolicies)) {
            throw new \InvalidArgumentException('non-nullable fulfillmentPolicies cannot be null');
        }
