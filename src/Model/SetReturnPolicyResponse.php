...
class SetReturnPolicyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('returnPolicyId', $data ?? [], null);
    ...
    */
     ...
     * Sets categoryTypes
     *
     * @param \macropage\SDKs\ebay\rest\account\Model\CategoryType[]|null $categoryTypes This field always returns <code>ALL_EXCLUDING_MOTORS_VEHICLES</code> for return business policies, since return business policies are not applicable to motor vehicle listings.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $extendedHolidayReturnsOffered <p class=\"tablenote\"><span  style=\"color: #dd1e31;\"><b>Important!</b></span> This field is deprecated, since eBay no longer supports extended holiday returns. This field should no longer be returned.</p>
     *
     * @return self
     */
     ...
     *
     * @param string|null $restockingFeePercentage <p class=\"tablenote\"><span  style=\"color: #dd1e31;\"><b>Important!</b></span> This field is deprecated, since eBay no longer allows sellers to charge a restocking fee for buyer remorse returns.</p>
     *
     * @return self
     */
     ...
     * Sets returnMethod
     *
     * @param string|null $returnMethod This field will be returned if the seller is willing and able to offer an alternative return method other than 'money back', such as an exchange or replacement item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:ReturnMethodEnum'>eBay API documentation</a>
     *
     * @return self
     */
    ...
    public function setReturnPolicyId($returnPolicyId)
    {
        ...
        if (is_null($returnPolicyId)) {
            throw new \InvalidArgumentException('non-nullable returnPolicyId cannot be null');
        }
     ...
     *
     * @param bool|null $returnsAccepted If set to <code>true</code>, the seller accepts returns. If set to <code>false</code>, this field indicates that the seller does not accept returns.
     *
     * @return self
     */
