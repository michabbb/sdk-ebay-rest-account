...
class Program implements ModelInterface, ArrayAccess
{
     ...
     * Sets programType
     *
     * @param string|null $programType A seller program in to which a seller can opt-in. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/account/types/ProgramTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
