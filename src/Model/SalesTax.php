...
class SalesTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('salesTaxJurisdictionId', $data ?? [], null);
    ...
    */
     ...
     * Sets countryCode
     *
     * @param string|null $countryCode The country code enumeration value identifies the country to which this sales tax rate applies. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:CountryCodeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $salesTaxJurisdictionId A unique ID that identifies the sales tax jurisdiction to which the salest tax rate applies (for example, a state within the United States).
     *
     * @return self
     */
    public function setSalesTaxJurisdictionId($salesTaxJurisdictionId)
    {
        ...
        if (is_null($salesTaxJurisdictionId)) {
            throw new \InvalidArgumentException('non-nullable salesTaxJurisdictionId cannot be null');
        }
     ...
     *
     * @param string|null $salesTaxPercentage The sales tax rate that will be applied to sales price. The <b>shippingAndHandlingTaxed</b> value will indicate whether or not sales tax is also applied to shipping and handling charges<br><br>Although it is a string, a percentage value is returned here, such as <code>7.75</code>
     *
     * @return self
     */
     ...
     *
     * @param bool|null $shippingAndHandlingTaxed If returned as <code>true</code>, sales tax is also applied to shipping and handling charges, and not just the total sales price of the order.
     *
     * @return self
     */
